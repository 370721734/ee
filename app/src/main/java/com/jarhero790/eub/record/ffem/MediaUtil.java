package com.jarhero790.eub.record.ffem;
...
//    }
    ...
    public void combineVideo(File inputVideoFile, File inputAudioFile, File outputVideoFile) {
        ...
        try {
            mediaMuxer = new MediaMuxer(outputVideoFile.getAbsolutePath(), MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);//MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4
