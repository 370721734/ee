...
public class ZanAdapter extends RecyclerView.Adapter<ZanAdapter.MyHolder> {



    private Context context;
    private List<ZanBean.DataBean> list;
    private Myclick myclick;

    public ZanAdapter(Context context, List<ZanBean.DataBean> list, Myclick myclick) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View layout = View.inflate(context, R.layout.item_zan, null);
