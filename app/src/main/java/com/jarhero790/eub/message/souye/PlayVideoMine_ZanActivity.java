...
public class PlayVideoMine_ZanActivity extends AppCompatActivity implements ITXVodPlayListener {
...
//    ArrayList<SearchBean.DataBean.LikeBean> likeBeans = new ArrayList<>();
    ArrayList<MyFaBuBean.DataBean> zuopinglist = new ArrayList<>();//作品
...
//            tikTokAdapter = new TikTokTwoAdapter(likeBeans, this, "like");
            ...
            zuopinglist = (ArrayList<MyFaBuBean.DataBean>) intent.getSerializableExtra("vidlist");
//            tikTokAdapter = new TikTokTwoAdapter(list, this);
    ...
    private void initViews() {
        ...
        mIvCover_heng = (ImageView) findViewById(R.id.player_iv_cover_heng);
...
//         }
        ...
        protected PlayerInfo instantiatePlayerInfo(int position) {
            ...
            vodPlayer.setVodListener(PlayVideoMine_ZanActivity.this);
            ...
            if (type.equals("zan")) {
                ZanBean.DataBean tcLiveInfo = zanBeanList.get(position);
                ...
                MyFaBuBean.DataBean tcLiveInfo = zuopinglist.get(position);
                playerInfo.playURL = TextUtils.isEmpty(tcLiveInfo.getUrl()) ? tcLiveInfo.getUrl() : tcLiveInfo.getUrl();
                playerInfo.reviewstatus = tcLiveInfo.getState();
            }
        ...
        public int getCount() {
            if (type.equals("zan")) {
                ...
                return zuopinglist == null ? 0 : zuopinglist.size();
            }
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            if (type.equals("zan")){
                ZanBean.DataBean videoinfo = zanBeanList.get(position);
...
//
//                Glide.with(PlayVideoMine_ZanActivity.this).load(videoinfo.getVideo_img()).apply(new RequestOptions()
//                        .placeholder(R.mipmap.mine_bg).error(R.mipmap.mine_bg)).into(coverImageView);


                if (videoinfo.getAnyhow().equals("1")) {
                ...
                Glide.with(PlayVideoMine_ZanActivity.this).load(videoinfo.getHeadimgurl()).apply(new RequestOptions().placeholder(R.mipmap.zuanshi_logo)
                ...
                MyFaBuBean.DataBean videoinfo = zuopinglist.get(position);
                View view = LayoutInflater.from(container.getContext()).inflate(R.layout.view_player_content_two, null);
                view.setId(position);
                // 封面
                ImageView coverImageView = (ImageView) view.findViewById(R.id.player_iv_cover);
...
//                        .placeholder(R.mipmap.mine_bg).error(R.mipmap.mine_bg)).into(coverImageView);
                ...
                CircleImageView userimage = (CircleImageView) view.findViewById(R.id.souye_logo);
                Glide.with(PlayVideoMine_ZanActivity.this).load(videoinfo.getHeadimgurl()).apply(new RequestOptions().placeholder(R.mipmap.zuanshi_logo)
                        .error(R.mipmap.zuanshi_logo).diskCacheStrategy(DiskCacheStrategy.NONE)).into(userimage);
                //旋转图
                CircleImageView guanpan = (CircleImageView) view.findViewById(R.id.circleImageView);
                Glide.with(PlayVideoMine_ZanActivity.this).load(videoinfo.getHeadimgurl()).apply(new RequestOptions().placeholder(R.mipmap.zuanshi_logo)
                        .error(R.mipmap.zuanshi_logo).diskCacheStrategy(DiskCacheStrategy.NONE)).into(guanpan);
                guanpan.setAnimation(rotateAnimation);
...
//                        mOnItemClickListerer.onItemClick(position, "点赞", view, tv_like, view, listtype);
                    ...
                    if (SharePreferenceUtil.getToken(AppUtils.getContext()).equals("")) {
                        startActivity(new Intent(PlayVideoMine_ZanActivity.this, LoginNewActivity.class));
                    } else {
...
//                Log.e("-----","hehe");
                    if (SharePreferenceUtil.getToken(AppUtils.getContext()).equals("")) {
                        ...
                        Intent intentx = new Intent(PlayVideoMine_ZanActivity.this, BusinessWebTwoActivity.class);
                        if (listtype.equals("zan")) {
                            ...
                            intentx.putExtra("url", "http://www.51ayhd.com/web/Shopping/#/shopindex/token/" + SharePreferenceUtil.getToken(AppUtils.getContext()) + "/good_id/" + zuopinglist.get(mCurrentPosition).getGood_id());
                            intentx.putExtra("good_id", zuopinglist.get(mCurrentPosition).getGood_id());
                        }
            ...
            guanpan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (SharePreferenceUtil.getToken(AppUtils.getContext()).equals("")) {
                        ...
                        Intent intentt = new Intent(PlayVideoMine_ZanActivity.this, TongKuanActivity.class);
                        if (listtype.equals("zan")) {
                            intentt.putExtra("video_id", zanBeanList.get(mCurrentPosition).getVideo_id());
                        } else {
                            intentt.putExtra("video_id", zuopinglist.get(mCurrentPosition).getVideo_id());
                        }
...
//        GlideCacheUtil.getInstance().clearImageMemoryCache(this);
    ...
    private void likeVideo(String listtype) {
        ...
        String vids = "";
        if (listtype.equals("zan")) {
            vids = zanBeanList.get(mCurrentPosition).getVideo_id() + "";
        } else {
            vids = zuopinglist.get(mCurrentPosition).getVideo_id() + "";
        }
    ...
    public void showPingLun(TextView tv, String like) {
        if (SharePreferenceUtil.getToken(AppUtils.getContext()).equals("")) {
            ...
            if (like.equals("zan")) {
                ...
                args.putString("vid", zuopinglist.get(mCurrentPosition).getVideo_id() + "");
            }
...
//                    }
    ...
    public void showShare(String liketype) {
        ...
        if (liketype.equals("zan")) {
            ...
            args.putString("url", zuopinglist.get(mCurrentPosition).getUrl());
            args.putString("videoid", zuopinglist.get(mCurrentPosition).getVideo_id() + "");
            args.putString("userid", zuopinglist.get(mCurrentPosition).getUid() + "");
        }
    ...
    private void attentions(String listtype, Button button) {
        String vid = "";
        if (listtype.equals("zan")) {
            vid = zanBeanList.get(mCurrentPosition).getUid() + "";
        } else {
            vid = zuopinglist.get(mCurrentPosition).getUid() + "";
        }
