 ...
 * data：16/7/27
 */
public class GridSingImageAdapter extends
        RecyclerView.Adapter<GridSingImageAdapter.ViewHolder> {
    ...
    public GridSingImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.mipmap.edit_tou_icon);
