...
public class LikeAdapter extends RecyclerView.Adapter<LikeAdapter.MyHolder> {
    ...
    @NonNull
    @Override
    public LikeAdapter.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.item_my_like_tu, null);
    ...
    public void onBindViewHolder(@NonNull LikeAdapter.MyHolder holder, int position) {
        ...
        Glide.with(context).load(bean.getVideo_img()).apply(new RequestOptions().placeholder(R.mipmap.mine_bg).error(R.mipmap.mine_bg)).into(holder.ivIcon);
