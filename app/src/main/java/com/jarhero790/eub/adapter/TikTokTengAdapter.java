...
//播放视频适配
public class TikTokTengAdapter extends RecyclerView.Adapter<TikTokTengAdapter.VideoHolder> {

    private List<Video> videos;
    private Context context;
    RotateAnimation rotateAnimation;//旋转动画
    private TikTokTengAdapter.OnItemClickListener mOnItemClickListerer;
    ...
    public void setOnItemClickListerer(TikTokTengAdapter.OnItemClickListener listerer) {
        this.mOnItemClickListerer = listerer;
    }


    public TikTokTengAdapter(List<Video> videos, Context context) {
        this.videos = videos;
    ...
    public VideoHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.view_player_content_two, parent, false);
